...
import com.github.ndrew.jasmine.exception.StringifiesStackTraces;
...
public class AbstractJasmineMojoTest {
  ...
  public void setsSourceExcludes() throws Exception {
    ...
    assertThat(this.subject.sources.getExcludes(), Matchers.is(com.github.ndrew.jasmine.Matchers.empty()));
  }
  ...
  public void setsSpecExcludes() throws Exception {
    ...
    assertThat(this.subject.specs.getExcludes(), Matchers.is(com.github.ndrew.jasmine.Matchers.empty()));
  }
