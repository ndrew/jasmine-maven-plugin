...
import com.github.ndrew.jasmine.io.scripts.ScriptResolverException;
...
import static com.github.ndrew.jasmine.Matchers.containsLinkTagWithSource;
import static com.github.ndrew.jasmine.Matchers.containsScriptTagWithSource;
...
public class SpecRunnerHtmlGeneratorPseudoIntegrationTest {
  ...
  public void populatesJasmineSource() throws Exception {
    ...
    assertThat(html, containsScriptTagWithSource(SpecRunnerHtmlGenerator.JASMINE_JS));
  }
  ...
  public void populatesJasmineHtmlSource() throws Exception {
    ...
    assertThat(html, containsScriptTagWithSource(SpecRunnerHtmlGenerator.JASMINE_HTML_JS));
  }
  ...
  public void shouldPopulateCSSIntoHtmlWhenProvided() throws Exception {
    ...
    assertThat(html, containsLinkTagWithSource(SpecRunnerHtmlGenerator.JASMINE_CSS));
  }
  ...
  private HtmlPage getPage(String html) throws Exception {
    ...
    for (String s : Arrays.asList(SpecRunnerHtmlGenerator.JASMINE_JS, SpecRunnerHtmlGenerator.JASMINE_HTML_JS, SpecRunnerHtmlGenerator.JASMINE_HTMLSPECFILTER_PATCH_JS, SpecRunnerHtmlGenerator.JASMINE_BOOT_JS)) {
      URL url = new URL("http://blah" + s);
      webConnection.setResponse(url, "", "application/javascript");
    }
